...
@Slf4j
@Controller
@RequestMapping(value = "/co_proveedor")
public class CoProveedorController {
    @Autowired
    private CoProveedorService service;

    @GetMapping(value = "/lista", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<?> listaCoProveedor(HttpServletRequest request,
